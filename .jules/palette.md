...
## 2025-02-28 - Focus States for Interactive Elements
**Learning:** Custom interactive elements (like mobile menu buttons or toggles) in this Next.js app may lack default focus rings for keyboard navigation.
**Action:** Explicitly add `focus-visible` Tailwind classes (e.g., `focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-hidden rounded-sm`) to custom `<button>`s or interactive elements to ensure proper keyboard accessibility.
